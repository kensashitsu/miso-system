...
export default function MoveForm({ lotId, lotNumber, currentLocation, currentStatus, heatingDefaultTemp, coolingDefaultTemp }: Props) {
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      const result = await moveLot(lotId, loc, moveDate, markAsComplete)
