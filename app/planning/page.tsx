...
export default async function PlanningPage() {
  ...
  // API在庫を品種別Mapに変換（熟成済バラ＋小分け製品の合算）。
  // 出荷はどちらからも出ていくので、在庫切れ判定・安全在庫ラインとも合算で統一する。
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-3 sm:px-4 py-4 sm:py-6 pb-16 space-y-6 sm:space-y-8">
      {/* タイトルとSARIMAX更新ボタン */}
